...
namespace AudioEngine
{
    ...
    unsigned RingBuffer::GetReadAvailable()
    {
        ...
        return (unsigned)((WriteIndex - ReadIndex) & BigMask);
    }
    ...
    unsigned RingBuffer::Write(const void* data, unsigned elementCount)
    {
        ...
        unsigned index = (unsigned)(WriteIndex & SmallMask);
        ...
        AtomicExchange(&WriteIndex, (WriteIndex + elementCount) & BigMask);
    ...
    unsigned RingBuffer::Read(void* data, unsigned elementCount)
    {
        ...
        unsigned index = (unsigned)(ReadIndex & SmallMask);
        ...
        AtomicExchange(&ReadIndex, (ReadIndex + elementCount) & BigMask);
