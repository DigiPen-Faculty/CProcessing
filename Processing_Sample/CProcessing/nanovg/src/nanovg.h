...
enum NVGtextureWrapMode {
	NVG_TEXTURE_WRAP_CLAMP,
	NVG_TEXTURE_WRAP_CLAMP_EDGE,
	NVG_TEXTURE_WRAP_REPEAT,
	NVG_TEXTURE_WRAP_MIRROR
};

enum NVGblendEquation {
	NVG_BLEND_EQUATION_ADD = 1 << 0,
	NVG_BLEND_EQUATION_SUBTRACT = 1 << 1,
	NVG_BLEND_EQUATION_MIN = 1 << 2,
	NVG_BLEND_EQUATION_MAX = 1 << 3,
};
...
// Sets current texture filter mode, which can be NVG_TEXTURE_FILTER_NEAREST or NVG_TEXTURE_FILTER_LINEAR.
void nvgTextureFilter(NVGcontext* ctx, int filterMode);

// Sets current texture wrap mode to CLAMP or REPEAT the edge color
void nvgTextureWrap(NVGcontext* ctx, int wrapMode);
