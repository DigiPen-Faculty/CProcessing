...
enum GLNVGtextureWrapMode {
	GLNVG_TEXTURE_WRAP_CLAMP,
	GLNVG_TEXTURE_WRAP_CLAMP_EDGE,
	GLNVG_TEXTURE_WRAP_REPEAT,
	GLNVG_TEXTURE_WRAP_MIRROR
};
...
static void glnvg__setTextureWrap(const GLuint textureWrap)
{
	if (textureWrap == GLNVG_TEXTURE_WRAP_CLAMP) {
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_BORDER);
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_BORDER);
	}
	else if (textureWrap == GLNVG_TEXTURE_WRAP_CLAMP_EDGE) {
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
	}
	else if (textureWrap == GLNVG_TEXTURE_WRAP_REPEAT) {
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	}
	else if (textureWrap == GLNVG_TEXTURE_WRAP_MIRROR) {
...
static GLenum glnvg_convertBlendFuncEquation(int equation)
{
	if (equation == NVG_BLEND_EQUATION_ADD)
		return GL_FUNC_ADD;
	if (equation == NVG_BLEND_EQUATION_SUBTRACT)
		return GL_FUNC_REVERSE_SUBTRACT;
	if (equation == NVG_BLEND_EQUATION_MIN)
		return GL_MIN;
	if (equation == NVG_BLEND_EQUATION_MAX)
		return GL_MAX;
